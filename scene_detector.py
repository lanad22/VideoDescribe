...
class PySceneDetector:
    def __init__(self, detection_method="content"):
        """Initialize scene detector with the specified method."""
        self.detection_method = detection_method
        self.detector = ContentDetector(threshold=27.0) if detection_method == "content" else None
    ...
    def detect_and_save_scenes(self, video_path: str, captions_path: Optional[str] = None) -> List[Dict]:
        ...
        for i, scene in enumerate(scene_list):
            ...
            print(f"Extracting scene {i+1}/{len(scene_list)}...")
